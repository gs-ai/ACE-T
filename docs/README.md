...
- 3D Three.js visualization interface (spectrum rendering)
...
- **GUI**: Three.js for 3D visualization
...
This launches:
- 3D Three.js GUI on `http://127.0.0.1:8050/gui/three_view_3d_v2.html`
...
Timestamps are rendered in the 3D viewer using the browser locale/timezone.
...
- `spectrum_export/build_graph_3d.py`: 3D spectrum export generation
- `ACE-T-SPECTRUM.py`: Headless spectrum export entry point
- `gui/three_view_3d_v2.html`: 3D GUI
